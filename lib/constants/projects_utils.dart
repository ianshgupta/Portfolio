...
List<ProjectUtils> projectUtils=[
  ProjectUtils(
      ...
      githubLink:'https://github.com/Ansh-Gupta-Official/OrderEase'
  ),
  ProjectUtils(
      ...
      githubLink:'https://github.com/Ansh-Gupta-Official/Budget_App'
  ),
  ...
  ProjectUtils(
      ...
      githubLink:'https://github.com/Ansh-Gupta-Official/Weather_App'
  ),
  ProjectUtils(
      image: "assets/img_2.png",
      title: 'Quiz Application',
      subtitle: 'Flutter‐Dart-Hive DB\n\n Engage, challenge, and learn with our dynamic quiz app, where knowledge meets excitement at every tap',
    githubLink: 'https://github.com/Ansh-Gupta-Official'
  ),
  ProjectUtils(
    ...
    githubLink: 'https://github.com/Ansh-Gupta-Official/To-Do_App'
  ),
];